import type { StoryContent, HomeVideoItem } from './home-types';
...
type Props = {
  ...
  videoPreviewKey: number;
  onPlayVideo: (video: HomeVideoItem) => void;
};

export function HomeStoryVideoSection({ story, videoItems, videoPreviewKey, onPlayVideo }: Props) {
            ...
            >
              ...
              >
                <ReactPlayer
                  ...
                  onClickPreview={() => onPlayVideo(video)}
                />
              </Box>
