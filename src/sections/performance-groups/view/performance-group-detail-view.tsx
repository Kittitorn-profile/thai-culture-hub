...
export function PerformanceGroupDetailView({ groupId, initialGroup }: Props) {
  ...
  useEffect(() => {
    ...
    fetch(`/api/performance-groups/counts?groupIds=${encodeURIComponent(groupId)}`, {
      ...
      .then(
        (json: { data?: Record<string, { views: number; shares: number }> } | null) => {
        ...
        >
          {group.coverImageUrl && (
            <Box
              ...
              sx={{ width: 1, maxHeight: 560, display: 'block', objectFit: 'cover' }}
            />
          )}
          ...
          <Box sx={{ p: { xs: 2.5, md: 5 } }}>
            ...
            >
              ...
              <Stack direction="row" spacing={1} useFlexGap flexWrap="wrap">
                ...
                {group.acceptsBookings && <Chip label="เปิดรับงาน" color="success" variant="outlined" />}
              </Stack>
            </Stack>
            ...
            <Stack direction="row" spacing={1.25} useFlexGap flexWrap="wrap" sx={{ mt: 3 }}>
              ...
              {group.lineUrl && <Button component="a" href={group.lineUrl} target="_blank">LINE</Button>}
              {group.facebookUrl && <Button component="a" href={group.facebookUrl} target="_blank">Facebook</Button>}
              {group.youtubeUrl && <Button component="a" href={group.youtubeUrl} target="_blank">YouTube</Button>}
            </Stack>
            ...
            >
              <Typography sx={{ fontWeight: 900 }}>แชร์วงนี้</Typography>
            ...
            {group.yearlyData.length > 0 && (
              <Box
                ...
                sx={{
                  ...
                  p: { xs: 2, md: 3 },
                  borderRadius: 3,
                  bgcolor: 'rgba(111,135,144,0.07)',
                  border: '1px solid rgba(42,55,54,0.08)',
                }}
              >
                  ...
                  {group.yearlyData
                    ...
                    <Box
                      ...
                      sx={{
                        ...
                        borderLeft: `6px solid ${group.primaryColor || '#637e69'}`,
                        bgcolor: '#fff',
                        ...
                        <Box sx={{ mt: 2.5 }}>
                          <Box
                            sx={{
                              ...
                              color: '#f8f6ee',
                              background:
                                'linear-gradient(135deg, rgba(42,55,54,0.96), rgba(99,126,105,0.9))',
                            }}
                          >
